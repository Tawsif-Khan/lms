    ...
    <div class="margin-top">
        <div class="row">	
            <div class="span12">	
                ...
                <div class="alert alert-info"><strong> New Member</strong></div>

                
                <div class="addstudent">
                    <div class="details"><strong>Please Enter Details Below</strong></div>
                    <?php if (isset($_REQUEST['error'])) { ?>
                        <div class="alert alert-info">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <strong><i class="icon-user icon-large"></i>&nbsp;<?php echo $_REQUEST['error'];?> </strong>
                        </div>
                    ...
                    <form class="form-horizontal" method="POST" action="member_save.php" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="inputEmail" name="userId"  placeholder="User Id" required>
