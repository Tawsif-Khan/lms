        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav">
                    ...
                    <li class="active"><a href="pdf_books.php"><i class="icon-book icon-large"></i>&nbsp;PDF Books</a></li>
...
<li><a href="advancedRequestList.php" ><i class="icon-search icon-large"></i>&nbsp;Advance Book Requests</a></li><!-- <li><a href="section.php"><i class="icon-group icon-large"></i>&nbsp;Sections</a></li> -->
