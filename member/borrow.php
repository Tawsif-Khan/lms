    ...
    <div class="margin-top">
        <div class="row">	
            ...
            <div class="span12">		
                ...
                <form method="post" action="advanceIssueSave.php">
                    <div class="span1">
                    ...
                    <div class="span10">
                        <div class="alert alert-success"><b>Select Book</b>
                            

                            <button name="delete_student" style="float: right;" class="btn btn-success"><i class="icon-plus-sign icon-large"></i> Send request</button>
