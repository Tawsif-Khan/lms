        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse" >
                <ul class="nav" >
                    ...
                    <li class="">
                        <a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="member/"><i class="icon-user icon-large"></i>&nbsp;Member</a>
                    </li>
                    <li class="">
                        <a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="add_member.php"><i class="icon-user icon-large"></i>&nbsp;New Member</a>
                    </li>
